package com.example.oscar.retrosquash;
...
public class MainActivity extends AppCompatActivity {
    ...
    //for getting display detail like the number of pixels
    Display display;
    Point size;
    int screenWidth;
    int screenHeight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            //Catch objects of the 2 requied classes
            AssetManager assetManager = getAssets();
            AssetFileDescriptor descriptor;

            //create our three fx in memory ready for use
            descriptor = assetManager.openFd("Jump1.ogg");
            sample1 = soundPool.load(descriptor, 0);

            descriptor = assetManager.openFd("Jump2.ogg");
            sample2 = soundPool.load(descriptor, 0);

            descriptor = assetManager.openFd("Jump3.ogg");
            sample3 = soundPool.load(descriptor, 0);

            descriptor = assetManager.openFd("Jump4.ogg");
        ...
        //Dont want just anyone changing screen size
